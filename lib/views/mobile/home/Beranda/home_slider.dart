                  ...
                  child: Card(
                    ...
                    child: SizedBox(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text("Masukan Data Lahan", textAlign: TextAlign.center,style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.black,)),
                        )),
                  )),
            ),
            GestureDetector(
                  ...
                  child: Card(
                    ...
                    child: SizedBox(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text("Info Data Lahan", textAlign: TextAlign.center, style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold,color: Colors.black)),
                        )),
                  )),
            ),
          ],
