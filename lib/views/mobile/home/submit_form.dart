            ...
            children: <Widget>[
              ...
              Card(
                ...
                child: DataTable(columns: <DataColumn>[
                  DataColumn(label: Text('Estimasi Kebutuhan Unsur Hara N', style: TextStyle(fontWeight: FontWeight.normal),)),
                  DataColumn(label: Text(prediksi.n +' Kg/Ha/Thn',style: TextStyle(fontWeight: FontWeight.normal),)),
                ], rows: <DataRow>[
